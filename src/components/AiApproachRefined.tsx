...
export default function AiApproachRefined() {
  ...
  return (
    <section ref={containerRef} className="relative flex min-h-[72vh] items-center justify-center overflow-hidden border-t border-white/[.05] bg-[#0a0a0a] px-6 py-20 md:px-12 md:py-24">
