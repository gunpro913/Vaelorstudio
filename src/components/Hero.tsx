...
export default function Hero() {
  ...
  // Layered depth reveals for words
  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full bg-aer-black overflow-hidden flex items-center justify-center">
      
      {/* Editorial annotations */}
      <div className="absolute top-32 left-6 md:left-12 text-[9px] tracking-[0.3em] text-aer-cream/30 flex flex-col gap-1 hidden md:flex">
        <span>IDX: 001</span>
        <span>SYS: ONLINE</span>
        <span>LAT: 40.7128° N</span>
      </div>

      <div className="absolute bottom-12 right-6 md:right-12 text-[9px] tracking-[0.3em] text-aer-cream/30 flex flex-col gap-1 text-right hidden md:flex">
        <span>AER × VÆLOR</span>
        <span>EST. 2026</span>
      </div>
