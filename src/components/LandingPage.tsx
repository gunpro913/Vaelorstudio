  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#0a0b0b] text-aer-cream selection:bg-aer-blue selection:text-black">
      ...
      <main id="top" className="relative z-10">
        <section className="relative flex min-h-screen items-end overflow-hidden border-b border-white/[.07] px-5 pb-16 pt-32 md:px-10 md:pb-24"><div className="absolute inset-0 bg-[radial-gradient(ellipse_at_70%_45%,rgba(120,210,225,.16),transparent_22%),radial-gradient(ellipse_at_82%_30%,rgba(255,255,255,.13),transparent_13%),linear-gradient(110deg,#0a0b0b_30%,#081215_62%,#0a0b0b)]" /><div className="absolute right-[13%] top-[13%] h-[48vw] w-[20vw] max-h-[640px] rounded-[50%_50%_6%_6%] border border-white/20 bg-black/20 shadow-[0_0_100px_rgba(64,224,208,.09)]" /><div className="absolute right-[14%] top-[16%] h-[42vw] w-[17vw] max-h-[560px] rounded-[50%_50%_3%_3%] bg-[radial-gradient(ellipse_at_70%_25%,rgba(255,255,255,.5),transparent_18%),linear-gradient(90deg,transparent,rgba(64,224,208,.08),transparent)] blur-[1px]" /><div className="absolute left-[7%] right-[7%] top-[24%] h-px bg-white/[.06]" /><div className="absolute bottom-[19%] left-[7%] right-[7%] h-px bg-white/[.06]" /><div className="relative mx-auto w-full max-w-[1500px]"><div className="grid items-end gap-12 md:grid-cols-[1.1fr_.55fr]"><div><SectionLabel>Digital studio / 001</SectionLabel><motion.h1 {...reveal()} className="max-w-5xl font-editorial text-[clamp(4rem,8.8vw,10rem)] leading-[.82] tracking-[-.045em]">Ideas, engineered<br /><span className="text-white/35">for what’s next.</span></motion.h1><motion.p {...reveal(.12)} className="mt-8 max-w-lg text-sm leading-7 text-white/55 md:mt-9 md:max-w-xl md:text-base">AER × VÆLOR is a digital studio combining strategy, design and engineering to build intelligent products for ambitious brands.</motion.p><motion.a {...reveal(.2)} href="#work" className="mt-8 inline-flex items-center gap-4 rounded-full border border-white/20 px-5 py-3 text-[9px] uppercase tracking-[.28em] transition duration-300 hover:border-aer-blue hover:bg-aer-blue hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-aer-blue focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0b0b]">Explore our work <ArrowDownRight size={14} /></motion.a></div><div className="hidden pb-3 md:block"><div className="ml-auto max-w-[180px] border-l border-white/10 pl-5 text-[8px] uppercase leading-5 tracking-[.25em] text-white/35">Strategy<br />Design<br />Motion<br />Engineering<br /><span className="text-aer-blue">—</span><br />Systems that feel inevitable.</div></div></div><div className="mt-14 flex items-center justify-between text-[8px] uppercase tracking-[.25em] text-white/30 md:mt-16"><span>Scroll to explore</span><span>01 / 07 <span className="ml-3 text-aer-blue">●</span></span></div></div></section>

        <section id="work" className="mx-auto max-w-[1500px] px-5 py-28 md:px-10 md:py-36"><motion.div {...reveal()} className="mb-12 flex items-end justify-between gap-8"><div><SectionLabel>Selected directions / 002</SectionLabel><h2 className="max-w-3xl font-editorial text-5xl leading-[.9] tracking-[-.03em] md:text-7xl">Work with<br /><span className="text-white/35">a point of view.</span></h2></div><span className="hidden text-[8px] uppercase tracking-[.25em] text-white/35 md:block">Proof of thinking</span></motion.div><div className="grid gap-3 md:grid-cols-[1.35fr_.65fr]"><motion.article {...reveal()} className="group min-h-[560px] overflow-hidden rounded-[26px] border border-white/10 bg-[#0e1111] p-3 transition duration-500 hover:-translate-y-1 hover:border-aer-blue/40"><div className="relative h-full min-h-[540px]"><ProjectVisual variant={0} /><div className="absolute inset-x-7 bottom-7 flex items-end justify-between gap-6"><div><div className="mb-3 text-[8px] uppercase tracking-[.25em] text-aer-blue">01 / Commerce / System</div><h3 className="font-editorial text-4xl md:text-5xl">Velora</h3><p className="mt-2 max-w-md text-xs leading-5 text-white/45">A commerce system exploring speed, hierarchy and confident decision-making.</p><div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 text-[7px] uppercase tracking-[.22em] text-white/25"><span>Direction</span><span>UX / UI</span><span>Engineering</span></div></div><ArrowRight className="shrink-0 text-white/50 transition group-hover:text-aer-blue" /></div></div></motion.article><div className="grid gap-3"><motion.article {...reveal(.08)} className="group relative min-h-[278px] overflow-hidden rounded-[26px] border border-white/10 bg-[#0e1111] p-3 transition duration-500 hover:-translate-y-1 hover:border-aer-blue/40"><ProjectVisual variant={1} /><div className="absolute inset-x-8 bottom-7 flex items-end justify-between gap-5"><div><div className="mb-2 text-[8px] uppercase tracking-[.25em] text-aer-blue">02 / Brand / Experience</div><h3 className="font-editorial text-3xl">Nimble</h3><p className="mt-2 max-w-xs text-xs leading-5 text-white/40">A brand experience turning a complex offer into a clearer, more confident journey.</p><div className="mt-3 text-[7px] uppercase tracking-[.22em] text-white/25">Positioning · Identity · Experience</div></div><ArrowUpRight size={18} className="shrink-0 text-white/45 transition group-hover:text-aer-blue" /></div></motion.article><motion.article {...reveal(.16)} className="group relative min-h-[278px] overflow-hidden rounded-[26px] border border-white/10 bg-[#0e1111] p-3 transition duration-500 hover:-translate-y-1 hover:border-aer-blue/40"><ProjectVisual variant={2} /><div className="absolute inset-x-8 bottom-7 flex items-end justify-between gap-5"><div><div className="mb-2 text-[8px] uppercase tracking-[.25em] text-aer-blue">03 / Product / Interface</div><h3 className="font-editorial text-3xl">Flux</h3><p className="mt-2 max-w-xs text-xs leading-5 text-white/40">A product direction focused on reducing noise and making the next action obvious.</p><div className="mt-3 text-[7px] uppercase tracking-[.22em] text-white/25">Product · UX · Interface</div></div><ArrowUpRight size={18} className="shrink-0 text-white/45 transition group-hover:text-aer-blue" /></div></motion.article></div></div><div className="mt-8 flex items-center justify-between border-t border-white/10 pt-5 text-[8px] uppercase tracking-[.2em] text-white/20"><span>03 directions / 01 connected system</span><span>AER × VÆLOR</span></div></section>
