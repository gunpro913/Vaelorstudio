  ...
  return (
    ...
    >
      ...
      <div className={`w-full md:w-5/12 pl-12 md:pl-0 ${isEven ? 'md:pr-16 md:text-right' : 'md:pl-16 md:text-left'}`}>
        ...
        <h3 className="font-editorial text-3xl md:text-5xl lg:text-6xl uppercase mb-4 group-hover:italic transition-all duration-500">{step.title}</h3>
...
export default function Process() {
  ...
  return (
    <section id="process" ref={containerRef} className="py-32 md:py-48 bg-aer-black relative">
